...
def keras_model(imagex,imagey):
    ...
    filepath = "C:/Users/Saurabh/Documents/AI/Hindi Character Recog using CNN/devanagari4.h5"
...
x = pickle.load(open("C:/Users/Saurabh/Documents/AI/Hindi Character Recog using CNN/x1.pickle","rb"))
y = pickle.load(open("C:/Users/Saurabh/Documents/AI/Hindi Character Recog using CNN/y1.pickle","rb"))
...
hist = model.fit(x, trainy, epochs=6, batch_size=64, validation_split=0.1, callbacks=callbacks_list)
